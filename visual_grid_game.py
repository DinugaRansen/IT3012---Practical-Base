...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None):
        ...
        return {
            ...
            'smells_toxin': tuple(self.agent_pos) in self.toxic_traps,         //implementation2.2  Lab1
 ...
 def get_percept(self) -> dict:
    ...
    # Assume agent is facing UP
    front_cell = (x, y + 1)

    wall_ahead = (
        front_cell in self.walls or
        front_cell[0] < 0 or                                         //Implementation 1.1 Lab 2
    ...
    def execute_action(self, action: str):
        ...
        if tuple_pos in self.food_positions:
            ...
            if tuple_pos in self.toxic_traps: #Implementation2.3
            self.score -= 15
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.toxic_traps:
            ...
            y1 = ty * self.cell_size + 5           #Impplementation2.3
            x2 = (tx + 1) * self.cell_size - 5
            y2 = (ty + 1) * self.cell_size - 5
            canvas.create_oval(x1, y1, x2, y2, fill="purple", outline="darkmagenta")
